...
namespace kaixo {
    namespace _tests {
        ...
        //
        //static_assert(_big_info::remove_indices<0>::size == 5);
        //static_assert(_big_info::remove_indices<5>::size == 5);
        //static_assert(same_as<_big_info::remove_indices<5>::last<1>::type, long>);
        //
