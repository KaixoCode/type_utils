...
namespace kaixo {
    ...
    namespace has {
        ...
        constexpr auto type = type_filter<type_impl>{};
        constexpr auto value = type_filter<value_impl>{};
        constexpr auto size = type_filter<size_impl>{};
        constexpr auto off_type = type_filter<off_type_impl>{};
        constexpr auto state_type = type_filter<state_type_impl>{};
        constexpr auto int_type = type_filter<int_type_impl>{};
        constexpr auto pos_type = type_filter<pos_type_impl>{};
        constexpr auto char_type = type_filter<char_type_impl>{};
        constexpr auto comparison_category = type_filter<comparison_category_impl>{};
        constexpr auto traits_type = type_filter<traits_type_impl>{};
        constexpr auto string_type = type_filter<string_type_impl>{};
        constexpr auto format = type_filter<format_impl>{};
        constexpr auto iterator_category = type_filter<iterator_category_impl>{};
        constexpr auto iterator_concept = type_filter<iterator_concept_impl>{};
        constexpr auto key_type = type_filter<key_type_impl>{};
        constexpr auto mapped_type = type_filter<mapped_type_impl>{};
        constexpr auto key_compare = type_filter<key_compare_impl>{};
        constexpr auto value_compare = type_filter<value_compare_impl>{};
        constexpr auto node_type = type_filter<node_type_impl>{};
        constexpr auto insert_return_type = type_filter<insert_return_type_impl>{};
        constexpr auto value_type = type_filter<value_type_impl>{};
        constexpr auto allocator_type = type_filter<allocator_type_impl>{};
        constexpr auto size_type = type_filter<size_type_impl>{};
        constexpr auto difference_type = type_filter<difference_type_impl>{};
        constexpr auto reference = type_filter<reference_impl>{};
        constexpr auto const_reference = type_filter<const_reference_impl>{};
        constexpr auto pointer = type_filter<pointer_impl>{};
        constexpr auto const_pointer = type_filter<const_pointer_impl>{};
        constexpr auto iterator = type_filter<iterator_impl>{};
        constexpr auto const_iterator = type_filter<const_iterator_impl>{};
        constexpr auto reverse_iterator = type_filter<reverse_iterator_impl>{};
        constexpr auto const_reverse_iterator = type_filter<const_reverse_iterator_impl>{};
    }
